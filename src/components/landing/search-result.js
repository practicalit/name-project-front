...
const SearchResult = ({ searchResult }) => {
    searchResult = searchResult != null && Array.isArray(searchResult) ? searchResult[0] : null;
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                                ...
                                <h3>Meaning</h3>
                                <p className="lead mb-0">{searchResult.definition != null && searchResult.definition != '' ?
                                    searchResult.definition : <Link to={{ pathname: '/more-detail', state: { name: searchResult.name } }}>I know the meaning..</Link>}</p>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <div className="col-lg-4">
                            <div className="features-icons-item mx-auto mb-0 mb-lg-3">
                                ...
                                <p className="lead mb-0">The origin of your name is {searchResult.origin}</p>
                            </div>
                        </div>
                    </div>
                </div>
